...
@section('title', 'Non Restricted Medication')
@section('content-header', 'Non Restricted Medication')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('nonrestricted.replicate', $nonrestricted) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                           id="name"
                           placeholder="Name" value="{{ old('name', $nonrestricted->name) }}" readonly>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="ward" class="form-control @error('ward') is-invalid @enderror"
                           id="ward"
                           placeholder="" value="{{ old('ward', $nonrestricted->ward) }}">
                    @error('ward')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="drug" class="form-control @error('drug') is-invalid @enderror" id="drug"
                           placeholder="Email" value="{{ old('drug', $nonrestricted->drug) }}">
                    @error('drug')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="dosege" class="form-control @error('dosege') is-invalid @enderror" id="dosege"
                           placeholder="Room Number" value="{{ old('dosege', $nonrestricted->dosege) }}">
                    @error('dosege')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="total" class="form-control @error('total') is-invalid @enderror" id="total"
                           placeholder="Contact Number" value="{{ old('total', $nonrestricted->total) }}">
                    @error('total')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nurse" class="form-control @error('nurse') is-invalid @enderror"
                           id="nurse"
                           placeholder="nurse" value="{{ old('nurse', $nonrestricted->nurse) }}">
                    @error('nurse')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="pharmacist" class="form-control @error('pharmacist') is-invalid @enderror"
                           id="pharmacist"
                           placeholder="pharmacist" value="{{ old('pharmacist', $nonrestricted->pharmacist) }}">
                    @error('pharmacist')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
